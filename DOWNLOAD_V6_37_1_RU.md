...
Архив создаётся самим GitHub из полного дерева коммита и включает исходный код, 15 мини-игр, всю музыку, озвучку, кат-сцены, спрайты, секретные материалы, документацию и тесты.
