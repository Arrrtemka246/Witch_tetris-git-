...
Статус: проектное предложение и перечень материалов. Рабочие прототипы правил находятся в `prototypes/`, но текущая игра их не импортирует.
...
- Механика отличается от всех 11 существующих мини-игр.
...
Причины те же, что у отменённой Irma Reigning: разметка таймингов, зависимость от конкретного MP3, анимации под темп и сложное тестирование задержки звука. Старые недостижимые ветки `IRMA RAIN DANCE` следует удалить отдельно.
...
- субтитры должны показывать имя говорящего и не перекрывать стакан Tetris.
...
### Вариант B — очередь аудио и субтитров — рекомендуется
...
Плюсы: безопасное поэтапное внедрение, понятные паузы, отсутствие одновременного звука.

Минусы: потребуется компактная панель субтитров.
...
Система может работать до получения всех 42 файлов: отсутствующая озвучка заменяется текстовым субтитром.
...
2. Должны ли отвечать все семь персонажей, включая Калеба и Бланка?
3. Показывать субтитры всегда или только при отсутствии аудиофайла?
4. Можно ли одной цепочке повториться после перезапуска новой игры?
5. Нужны ли разговоры только на этапе 0–99 или также во время сопротивления 100–199?
6. Может ли реплика начаться во время быстрого падения фигуры, или разговоры разрешены только сразу после спокойного появления?
