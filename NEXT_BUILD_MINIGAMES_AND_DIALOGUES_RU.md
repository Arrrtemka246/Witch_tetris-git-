...
Статус после решения автора для v6.37: четыре одноэкранные игры подключены к Collection. Диалоговый код остаётся изолированным исследовательским прототипом и не импортируется основной игрой.
